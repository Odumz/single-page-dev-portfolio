...
<template>
  <main class="space-grotesk-medium">
    ...
    <section class="landing">
      ...
      <img src="https://res.cloudinary.com/odumz/image/upload/v1717767487/projects/spdp-landing-ring-vector_cnenjd.png" alt="spdp ring vector" class="absolute object-cover top-8 md:top-6 xl:top-[3.875rem] -mx-[165px]">
    ...
    <hr class="md:hidden w-full text-[#979797]">
...
.menu-items {
  @apply hover:text-spdp-ash cursor-pointer transition-all duration-300 ease-in-out;
}
...
.skills {
  @apply relative grid content-start grid-cols-1 md:grid-cols-2 xl:grid-cols-3 my-10 md:my-[3.25rem] xl:my-[4.5rem] gap-y-6 md:gap-y-[3.25rem] xl:gap-y-[3.625rem];
}
...
.project-item__btns {
  @apply absolute grid content-center justify-items-center gap-y-5 md:gap-y-9 xl:gap-y-12 bg-black h-full w-full top-0 bg-opacity-75;
}
</style>
